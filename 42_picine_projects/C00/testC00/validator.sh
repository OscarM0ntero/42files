...
gcc -Wall -Wextra -Werror test/ex4.c ex04/ft_is_negative.c ex00/ft_putchar.c && ./a.out && rm -rf ./a.out
echo "\n"
read -n 1 -r -s -p $'Press any key to continue...CTR+C to cancel\n';
...
gcc -Wall -Wextra -Werror test/ex7.c ex07/ft_putnbr.c ex00/ft_putchar.c && ./a.out && rm -rf ./a.out
echo "\n"
read -n 1 -r -s -p $'Press any key to continue...CTR+C to cancel\n';

echo "############### EX08 ###############"
norminette -R CheckForbiddenSourceHeader ex08/ft_print_combn.c
gcc -Wall -Wextra -Werror test/ex8.c ex08/ft_print_combn.c ex00/ft_putchar.c && ./a.out && rm -rf ./a.out
echo "\n"
read -n 1 -r -s -p $'Press any key to continue...CTR+C to cancel\n';
